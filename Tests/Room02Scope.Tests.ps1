...
$room02BgmPath = Join-Path $root "Assets/Room02_Operating/Audio/Resources/Room02_Audio/grimyth - You shouldn't have come here.wav"
$oldBgmPath = Join-Path $root 'Assets/music/darkness/dk-atmosphere.aif'
$room02IntroSfxPath = Join-Path $root 'Assets/Room02_Operating/Resources/Audio/Intro/guts_and_gore_19.wav'
$oldIntroSfxFolderPath = Join-Path $root 'Assets/Deadly Kombat Free version'
$oldRoom02IntroSfxPackPath = Join-Path $root 'Assets/Room02_Operating/Resources/Audio/SFX/Deadly Kombat Free version'
...
Assert-True (Test-Path -LiteralPath $room02IntroSfxPath) 'Room02 intro SFX must live under Assets/Room02_Operating/Resources/Audio/Intro.'
...
Assert-True (-not (Test-Path -LiteralPath $oldRoom02IntroSfxPackPath)) 'Only the selected intro SFX should remain; the full imported SFX package must not stay in Room02 Resources.'
