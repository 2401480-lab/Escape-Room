...
Assert-True ($popup -match 'Input\.GetMouseButtonDown\s*\(\s*0\s*\)' -and $popup -match 'popupVisible') 'CluePickupPopupUI must keep the popup open until the player clicks.'
